...
<div class="header">
    ...
    <div class="rt-col">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onclick="lock_screen()"><img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a><span>|</span><a href="<?php echo $currentsite['domain']?>" target="_blank">首页</a>
    <ul id="Skin">
