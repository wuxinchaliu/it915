    ...
    <div class="column-block">
        <section class="article-left left">
            <article>
                ...
                <div class="cate_channel box" <?php if($j%2==1) { ?>style="margin-right:30px"<?php } ?>>
                <h3><span><a href="<?php echo $v['url'];?>" class="red"><?php echo $v['catname'];?></a></span></h3>
                <ul class="lanmu">
                    <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"content\" data=\"op=content&tag_md5=2516164b961a69e8ed02f9b93fb48dd0&action=lists&catid=%24v%5Bcatid%5D&num=10&order=id+DESC\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">修改</a>";}$content_tag = pc_base::load_app_class("content_tag", "content");if (method_exists($content_tag, 'lists')) {$data = $content_tag->lists(array('catid'=>$v[catid],'order'=>'id DESC','limit'=>'10',));}?>
